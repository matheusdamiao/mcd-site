...
export default function OpenCompany() {
  ...
  return (
    <main className='m-0 flex w-full flex-col bg-[#F2F2F2]'>
      ...
      <a
        className='font-primary fixed bottom-2 right-2 z-[888888888888888] flex w-[200px] items-center justify-center gap-2 rounded-3xl  bg-[#5ECC66] px-2 py-2 font-semibold text-white lg:bottom-10 lg:right-10 lg:w-[250px] lg:gap-4 lg:px-4 lg:py-3'

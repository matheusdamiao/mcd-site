...
export default function NavBar() {
  return (
    <div className='fixed left-0 z-[9999] m-auto w-full  lg:m-auto lg:mt-4 lg:px-14'>
      <Navbar
        className='h-full w-full border-[1px] bg-white bg-opacity-80  px-2 py-3  opacity-90 lg:flex  lg:w-full  lg:rounded-[34.6px] lg:px-6 lg:py-0 lg:shadow-md lg:[&>div]:w-full lg:[&>div]:flex-nowrap lg:[&>div]:gap-20 lg:[&>div]:px-8 '
        fluid
        rounded
      >
